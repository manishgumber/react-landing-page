            ...
            <div className="feed container">
                {
                    ...
                    globalState.feed.map(                
                        item => (<FeedCard name={item.user}  comment={item.comment}></FeedCard>)           
                ...
                <div className="input-group">                   
                    <textarea ref={(txtArea) => commentField = txtArea}  type="text" className="form-control" placeholder="Enter your comment" rows="3" ></textarea>
                
                    <div className="input-group-append">
                        <button className="btn btn-primary" type="button" id="btnPost" onClick={postHandler}>Post Comment</button>
                    </div>
                </div>
